...
class m130913_000000_consolidation extends OEMigration
{
    ...
    public function createTables()
    {
        ...
        $this->execute("DROP DATABASE IF EXISTS`openeyes`");
        $this->execute("CREATE DATABASE `openeyes`");
        $this->execute("USE `openeyes`");
        $this->execute(
            "CREATE TABLE `address` (
							 ...
							 `date_start` datetime DEFAULT '1900-01-01 00:00:00',
							 `date_end` datetime DEFAULT '1900-01-01 00:00:00',
